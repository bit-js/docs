...
### Route matching
The routing matching phase is JIT compiled by the [Blitz](https://www.npmjs.com/package/@bit-js/blitz) router.
You can ignore JIT compilation by using [EdgeRouter](https://www.npmjs.com/package/@bit-js/blitz#edge-router).
```ts
